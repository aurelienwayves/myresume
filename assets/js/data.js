...
const SITE_DATA = {
  ...
  video: {
    ...
    caption: "60 to 90 second intro: who I am, what I'm good at, what I'm looking for next."
  },
  ...
  //    link experience bullets to skills to other bullets. Everything
  //    here is backed by at least one real bullet below (no skill claims
  //    a track record it doesn't have): coursework-only competencies
  //    live under Education instead, as standalone course entries.
  // --------------------------------------------------------------------
  skillCategories: [
  ...
  skills: [
    ...
    { id: "technical-leadership", name: "Technical Leadership", categoryId: "leadership", blurb: "Leading technical teams and specialists day to day, not just managing a schedule." },
    ...
    { id: "regulatory-standards", name: "Regulatory & Standards Compliance", categoryId: "systems", blurb: "Delivering within formal standards and regulatory regimes: AS/NZS2293, Australia's Cybersecurity Act, telecom standardisation bodies, international product certification. A pattern that transfers across industries, not tied to one standard." },
    ...
    { id: "financial-control",  name: "Financial Control & ROI Analysis", categoryId: "business", blurb: "Cost accounting, budgeting and technology ROI calculations." },
    { id: "strategic-management", name: "Strategic & Innovation Management", categoryId: "business", blurb: "Strategic diagnostics and feasibility work applied to real programme decisions." },
    ...
    { id: "ip-protection",      name: "IP Protection & Technology Contracts", categoryId: "business", blurb: "Filed a Soleau envelope, working with the IP department, to protect an original hardware design." },
    ...
    { id: "cloud-mobile",         name: "Cloud & Web Platform", categoryId: "tools", blurb: "Linux/Docker services, Kotlin/Java plus React, Azure/WebSocket across dev/QA/prod." },
  ...
  experience: [
    ...
    },
    {
      ...
      bullets: [
        ...
        { text: "Personally led on-site RF field tests ahead of major releases, validating wireless signal quality and coverage in real buildings, leaning on the team's RF specialists rather than working solo.", skills: ["wireless-connectivity", "test-automation", "cross-functional", "technical-leadership"], image: "assets/img/photo/fieldtest.jpg" },
        { text: "Designed and shipped Galaxy Toolbox, an internal diagnostic tool that reads a unit's serial number on site, flags known PCB/firmware issues with a fix, and routes only genuinely new problems back to R&D. It replaced manual node-by-node analysis and meaningfully cut on-site diagnostic time and unnecessary parts/labour cost.", skills: ["process-digitalisation", "systems-architecture", "product-lifecycle"] },
        ...
        { text: "Supported Galaxy's expansion into Singapore, a new and heavily regulated market, coordinating lab testing and local certification alongside the core programme team.", skills: ["international-certification", "stakeholder-mgmt", "regulatory-standards"] },
    ...
    },
    {
      ...
      bullets: [
        { text: "Coordinated stakeholders across standardisation (10BASE-T1L / 10BASE-T1S), mechanical (connector prototyping), electronics (power/loss budget) and silicon vendors (Analog Devices, Microchip, NXP) to align the technology direction.", skills: ["stakeholder-mgmt", "systems-architecture", "regulatory-standards"] },
        ...
        { text: "Ran robustness and performance testing (cable distance, signal loss, live video calls over the IP link) and wrote a full technical report on results and KPIs to assess technical maturity.", skills: ["test-automation", "npi", "risk-management"] },
  ...
  linkedinPosts: [
    ...
    },
    {
      ...
      excerpt: "I didn't expect this experience to reshape the way I work so profoundly. A year ago, I moved to Australia as part of the V.I.E program, and it's been a fast-track journey, both professionally and personally...",
